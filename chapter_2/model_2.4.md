SIR with disease-induced mortality and frequency-dependent transmission
================
Bill Behrman
2020-04-11
...
function f(du, u, p, t)
  du[1] = p[4] - p[1] * u[1] * u[2] / (u[1] + u[2] + u[3]) - p[3] * u[1]
  du[2] = p[1] * u[1] * u[2] / (u[1] + u[2] + u[3]) -
    (p[2] + p[3]) / (1 - p[5]) * u[2]
...
![](model_2.4_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
